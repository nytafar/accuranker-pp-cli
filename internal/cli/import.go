...
but do not stop the import.`,
  ...
  accuranker-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  accuranker-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | accuranker-pp-cli import <resource> --input -`,
